...
export default function ContentWithImageField({ field, onLabelChange, onContentChange, onImageChange }: Props) {
  return (
    <div className="bg-white rounded-xl shadow-md p-6 mb-6 flex flex-col gap-4 border border-gray-200">
      ...
      <ContentInput content={field.content} onChange={onContentChange} />
       <ImageInput image={field.image} onChange={onImageChange} />
    </div>
  );
}