...
import ContentWithImageField from "./ContentWithImageField";
...
export default function ContentForm({ content, setContent, onSubmit }: Props) {
  return (
    <form
      onSubmit={onSubmit}
            ...
            return (
              <div key={key} className="mb-6">
                ...
                <input
                  ...
                  placeholder="Label"
                />
                {/* Loop durch die Unterfelder, zum Beispiel für die Trainingsinhalte */}
