...
export function getEmptyContentData(): ContentData {
  return {
    ...
    header: {
        ...
        backgroundAlt: "",
        navigation: {
          home: { label: "", href: "", isActive: true },
          about: { label: "", href: "", isActive: true },
          services: { label: "", href: "", isActive: true },
          team: { label: "", href: "", isActive: true },
          gallery: { label: "", href: "", isActive: true },
          testimonials: { label: "", href: "", isActive: true },
          contact: { label: "", href: "", isActive: true },
          impressum: { label: "", href: "", isActive: true },
          datenschutz: { label: "", href: "", isActive: true },
          agb: { label: "", href: "", isActive: true },
          faq: { label: "", href: "", isActive: true },
          blog: { label: "", href: "", isActive: true },
        },
    },
    about: { label: "", content: "" },
